...
class ECommerceInterface {
  ...
  function trace(msg) {
    if (parent.trace) console.log("Trace: " + msg);
  }
  ...
  {
      return true; //idk what this is but it seems to work fine
  ...
  function showOldPage(page)
  {
      ...
      while (!parent.hist[parent.hist.length - 1].includes(page)) {
        parent.hist.pop();
      }
      parent.goto(parent.hist[parent.hist.length - 1]);
  }
  ...
  function doPost(url, params)
  {
      ...
      formHTML += '<div id="post.commonFields"></div>';
          ...
          showPage(url + "?" + params);//form.submit();
      }
  }
  ...
  function showBack(index)
  {
      ...
      if (lastUrl != null) {
        trace("showBack: last url was " + lastUrl);
          //console.log(parent.hist);
          parent.hist.pop();
           //window.location.href = parent.hist[parent.hist.length - 1];
           parent.goto(parent.hist[parent.hist.length - 1]);
          //parent.hist.pop();
  ...
  function gotoPage(url, replace, secure) {
      //parent.currentiframe.location.replace("https://wiishopchannel.neocities.org/oss/serv/" + url);
      parent.goto(url);
  ...
  {
    if (parent.accurate == null) {
      if (points == null) {
        parent.points += 100;
      } else {
        parent.points = Math.max(parent.points + points, 0);
      }
      document.getElementById("currentBalance").innerText = Math.floor(parent.points);
      parent.setValue("points", parent.points);
    } else {
      var currUrl = getCurrentUrl();
      var page = getCurrentPage();
      ...
      if (typeof(r) == "object") {
          if ((r.country == 'KR' && r.region == 'KOR' && r.language == 'ko') || supportsCreditCard!="true") {
            ...
            if(shop.isCompatibleMode)
            {
            showPage("P_01_WiiU1st.html");
            }
            else
            {*/
            //showPage("P_01.html"); // I'll uncomment this when I make the "True Experience" feature.
            /*}
          }
      } else {
  ...
  function showRating(ratingSystem)
  {
      ...
      var url = addParam("B_07.html", "ratingUrl", ratingUrl);
      showPage(url);
  }
  ...
  function showOwnedTitles() {
      ...
      var form = createPostForm("ListOwnedTitlesForm", "B_04.html", false, inputHTML);
      form.submit();
  }
  ...
  function showHelpeeRegister() {
      ...
      var form = createPostForm("HelpeeRegisterForm", "S_17.html", true, inputHTML);
      form.submit();
  }
  ...
  function showHelpeeSuccess() {
      ...
      var form = createPostForm("HelpeeRegisterForm", "S_21.html", true, inputHTML);
      form.submit();
  }
  ...
  function showHelperRegister() {
      ...
      var form = createPostForm("HelperRegisterForm", "S_18.html", true, inputHTML);
      form.submit();
  }
  ...
  function showHelperStatus(page) {
      ...
      var form = createPostForm("HelperStatusForm", "S_20.html", true, inputHTML);
      form.submit();
  }
  
  function showSCAConfirm() {
      trace("showSCAConfirm");
      var form = createPostForm("SCAConfirm", "S_22.html", true, "");
      form.submit();
  }
  ...
  {
      trace("showManual");
      nextUrl = addParam("M_01.html", 'titleId', titleId);
      if (page != null && page != '') {
  ...
  function showAccessibleTitles() {
      ...
      var form = createPostForm("ListAccessibleTitlesForm", "B_04.html", false, inputHTML);
      form.submit();
  }
  ...
  function showGiftMessageSent(titleId, recipient) {
      ...
      var form = createPostForm("MessageSentForm", "B_26.html", true, inputHTML);
      form.submit();
  }
  ...
  function showTitle(titleId) {
      ...
      showPage("B_05.html?titleId=" + titleId);
  }
  ...
  function showGiftTitles() {
      ...
      var form = createPostForm("ListGiftTitlesForm", "B_04.html", true, inputHTML);
      form.submit();
  }
  ...
  function showGiftTrans(transId, passParentalControl)
  {
      ...
      var form = createPostForm("ShowGiftTransForm", "B_24.html", true, inputHTML);
      form.submit();	
  }
  ...
  function showGameCard(passParentalControl)
  {
      ...
      var form = createPostForm("showGameCardForm", getSecureUrl("B_31.html"), true, inputHTML);
      form.submit();	
  }
  ...
  function showGiftUsageTrans(transId)
  {
      ...
      var inputHTML = '<input type="hidden" name="transId" value="' + transId + '"/>';
      var form = createPostForm("ShowGiftTransForm", "H_03.html", true, inputHTML);
      form.submit();	
  }
  
  function goGiftNext(titleId)
  {
      var nextUrl = "W_03.html";
      if (ecSupportsSession()) {
  ...
  function showTransactions(page) {
      ...
      var form = createPostForm("ListTransForm", "H_01.html", true, inputHTML);
      form.submit();
  }
  ...
  function showReceipt(transactionId, transType) {
      ...
      var form = createPostForm("ReceiptForm", "H_02.html", true, inputHTML);
      form.submit();
  }
  ...
  function showCssTrans(transactionId) {
      ...
      var inputHTML = '<input type="hidden" name="transId" value="' + transactionId + '"/>';
      var form = createPostForm("ReceiptForm", "H_04.html", true, inputHTML);
      form.submit();
  }
  ...
  function showCheckBalance(next)
  {
      ...
      var form = createPostForm("CheckBalanceForm", "CheckBalance.html", true, inputHTML);
      form.submit();
  }
  ...
  function showCheckRegistered(forceCheck)
  {
      ...
      // Redirects to CheckRegistered.html with important device info	
      var url = "CheckRegistered.html";
      var r = ec.getDeviceInfo();
  ...
  function showRegister(action, memberId, password, next)
  {
      ...
      var form = createPostForm("RegisterForm", "Register.html", false, inputHTML);
      form.submit();
  }
  ...
  function doUnregister()
  {
      ...
      // Use HTTPS
      var inputHTML = "";
      var form = createPostForm("UnregisterForm", "S_10.html", false, inputHTML);
      form.submit();
  }
  ...
  function showParentalControlledPage(url, replace)
  {
      ...
      if (parentalControlOn) {
          ...
          showPage("L_04.html?next=" + encodeURIComponent(url), replace);
      } else {
  ...
  function postLog(info)
  {
      ...
      var form;
          ...
          if (form == null) {
              form = document.createElement("form");
              form.action = getSecureUrl("SaveLog.html");
              form.method = "post";
              form.id="LogForm";
              document.body.appendChild(form);
          }
  ...
  function init()
  {
      ...
      useSyncRegistration = true;//("getVersion" in ec && "syncRegistration" in ec);
  }
  ...
  function isFatalError()
  {
      ...
      if(previousPage != null && previousPage.indexOf('S_22.html') >= 0) {
          return true;
      }
  ...
  function setCursor(doc) {
    doc.body.innerHTML += "<div style='position: fixed; width: 100%; height: 100%; z-index: -1000000; top: 0; left: 0;'></div>"; // I hate this.
    if (parent.cursor || parent.parent.cursor) {
      var el = doc.body.querySelectorAll('*');
